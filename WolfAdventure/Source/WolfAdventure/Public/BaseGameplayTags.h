...
public:
	...
	FGameplayTag InputTag_Start;
	FGameplayTag InputTag_Select;
	FGameplayTag InputTag_EscAlt;
	...
	FGameplayTag CombatSocket_Bite;
	...
	FGameplayTag Player_Block_CrosshairTrace;
