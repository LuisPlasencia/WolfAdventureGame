...
/**
*  for a static variable we explicitly declare the type (necessary step for static variables in C++)
* 
*  Inside the class you are only declaring the variable, ie: you tell the compiler that there is something with this name. 
*  However, a static variable must get some memory space to live in, and this must be inside one translation unit. The compiler 
*  reserves this space only when you DEFINE the variable.
*/
...
void FBaseGameplayTags::InitializeNativeGameplayTags()
{
	...
	*/
	...
	// when we create a gameplay tag, it is registered with a gameplay tags manager (object that manages the gameplay tags)
	...
	*/
	...
	GameplayTags.CombatSocket_Bite = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("CombatSocket.Bite"),
		FString("Bite")
	);
